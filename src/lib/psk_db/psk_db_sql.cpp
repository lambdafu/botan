...
Encrypted_PSK_Database_Sqlite3::Encrypted_PSK_Database_Sqlite3(const secure_vector<uint8_t>& master_key,
                                                               const std::string& database_filename,
                                                               const std::string& table_name) :
   Encrypted_PSK_Database_SQL(master_key,
                              std::make_shared<Sqlite3_Database>(database_filename),
                              table_name)
   {
   }
