...
class BOTAN_PUBLIC_API(2,4) Encrypted_PSK_Database_Sqlite3 final : public Encrypted_PSK_Database_SQL
   {
   public:
      Encrypted_PSK_Database_Sqlite3(const secure_vector<uint8_t>& master_key,
